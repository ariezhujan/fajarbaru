...
<blockquote class="card">
  ...
  <p class="text-center"><a href="<?php echo site_url('admin/tangkimixer_page/action/tangkimixer1') ?>" class="btn btn-info">Edit / Konten 1</a></p>
</blockquote>
...
<blockquote class="card">
  <div class="section section-tank">
   ...
   <p class="text-center"><a href="<?php echo site_url('admin/tangkimixer_page/action/tangkimixer2') ?>" class="btn btn-info">Edit / Konten 2</a></p>
</blockquote>
...
<blockquote class="card">
    <div class="main-white section-check-free-pro section-white-gradient"> 
      ...
      <p class="text-center"><a href="<?php echo site_url('admin/tangkimixer_page/action/tangkimixer3') ?>" class="btn btn-info">Edit / Konten 3</a></p>
</blockquote>
...
<blockquote class="card">
  ...
  <p class="text-center"><a href="<?php echo site_url('admin/tangkimixer_page/action/tangkimixer4') ?>" class="btn btn-info">Edit / Konten 4</a></p>
</blockquote>
...
<div class="section-story-overview">
 ...
 <div class="tab-content gallery">
  <div class="tab-pane active" id="install" role="tabpanel">
    <div class="col-md-10 ml-auto mr-auto">
      <div class="row collections">
        <div class="col-md-6">
          <p class="text-center"><a href="<?php echo site_url('admin/tangkimixer_page/action/tangkimixer5left') ?>" class="btn btn-info">Edit Mixer Left</a></p>
          <?php foreach ($tangkimixer5left as $key) { ?>
              <img src="<?php echo base_url('upload/tangkimixer/'. $key->file) ?>" alt="" class="img-raised">
          <?php } ?>
        </div>
        <div class="col-md-6">
          <p class="text-center"><a href="<?php echo site_url('admin/tangkimixer_page/action/tangkimixer5right') ?>" class="btn btn-info">Edit Mixer Right</a></p>
  ...
  <div class="col-md-10 ml-auto mr-auto">
    <div class="row collections">
      <div class="col-md-6">
        <p class="text-center"><a href="<?php echo site_url('admin/tangkimixer_page/action/tangkimixer6left') ?>" class="btn btn-info">Edit Tank Left</a></p>
        <?php foreach ($tangkimixer6left as $key) { ?>
            <img src="<?php echo base_url('upload/tangkimixer/'. $key->file) ?>" alt="" class="img-raised">
        <?php } ?>
      </div>
      <div class="col-md-6">
        <p class="text-center"><a href="<?php echo site_url('admin/tangkimixer_page/action/tangkimixer6right') ?>" class="btn btn-info">Edit Tank Right</a></p>
