<blockquote class="card">
    <div class="section section-team text-center">
      <div class="container">
      <h2 class="title">Konten Home 1</h2>
      <div class="alert alert-success" role="alert"><?php echo $this->session->flashdata('data'); ?></div> 
        <div class="team">
          ...
          <!--Table head-->
            ...
            <!--Table body-->
            <tbody>
              <?php foreach($home1 as $key) { ?> 
              <tr>
                <td><?php echo $key->text; ?></td>
                <td><img style="width: 50%" src="<?php echo site_url('upload/dashboard/'. $key->file) ?>" ></td>
                <td>
                ...
                <td>
                  <a href="<?php echo site_url('admin/home_page/home1_remove') ?>?id=<?php echo $key->id ?>" title="Hapus" class="btn btn-sm btn-danger"><i class="now-ui-icons ui-1_simple-remove"></i></a>
                </td>
              </tr>
              <?php } ?>
            </tbody>
        ...
        <div class="col-sm-6 col-lg-10">
           <div class="panel panel-default">
            <div class="panel-body" style="margin-left: 100px">
              <form action="<?php echo site_url('admin/home_page/home1')?>" enctype="multipart/form-data" method="post" accept-charset="utf-8">
                  	<div class="row" >
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="col-sm-12 col-md-12 col-lg-12">
                <div class="row">
                <form class="form-horizontal" action="<?php echo base_url('admin/home_page/home1_edit')?>" method="post" enctype="multipart/form-data" role="form">
