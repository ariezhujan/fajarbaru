<blockquote class="card">
    <div class="section section-team text-center">
      <div class="container">
      <h2 class="title">Konten Conveyor 6</h2>
      <p class="text-danger"><?php echo $this->session->flashdata('data'); ?></p> 
        <div class="team">
          ...
          <!--Table head-->
            ...
            <!--Table body-->
            <tbody>
              <?php foreach($conveyor6 as $key) { ?> 
              <tr>
                <td><img style="width: 20%" src="<?php echo site_url('upload/conveyor/'. $key->file) ?>" ></td>
                <td>
                ...
                <td>
                  <a href="<?php echo site_url('admin/conveyor_page/conveyor6_remove') ?>?id=<?php echo $key->id ?>" title="Hapus" class="btn btn-sm btn-danger"><i class="now-ui-icons ui-1_simple-remove"></i></a>
                </td>
              </tr>
              <?php } ?>
            </tbody>
        ...
        <div class="col-sm-6 col-lg-10">
           <div class="panel panel-default">
            ...
            <div class="panel-body">
              ...
              <form action="<?php echo site_url('admin/conveyor_page/conveyor6') ?>" enctype="multipart/form-data" method="post" accept-charset="utf-8">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="col-sm-12 col-md-12 col-lg-12">
                <div class="row">
                <form class="form-horizontal" action="<?php echo base_url('admin/conveyor_page/conveyor6_edit')?>" method="post" enctype="multipart/form-data" role="form">
