<blockquote class="card">
    <div class="section section-team text-center">
      <div class="container">
      <h2 class="title">Konten Formulasi 6</h2>
          ...
          <!--Table head-->
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                  <a href="<?php echo site_url('admin/formulasi_page/formulasi6_remove') ?>?id=<?php echo $key->id ?>" title="Hapus" class="btn btn-sm btn-danger"><i class="now-ui-icons ui-1_simple-remove"></i></a>
                </td>
              </tr>
              <?php } ?>
            </tbody>
        ...
        <div class="col-sm-6 col-lg-10">
           <div class="panel panel-default">
            ...
            <div class="panel-body">
              ...
              <form action="<?php echo site_url('admin/formulasi_page/formulasi6') ?>" enctype="multipart/form-data" method="post" accept-charset="utf-8">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="col-sm-12 col-md-12 col-lg-12">
                <div class="row">
                <form class="form-horizontal" action="<?php echo base_url('admin/formulasi_page/formulasi6_edit')?>" method="post" enctype="multipart/form-data" role="form">
