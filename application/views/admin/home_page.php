...
<?php } ?>
  <div class="content-center">
      <div class="container">
        <?php if($header){ ?>
        <h4 class="title"><strong style="color: white;"> <?php echo $header->text ?></strong></h4>
        <?php } ?>
        <div class="text-center">
              <a class="btn btn-primary" rel="tooltip" title="Contact us on Phone" data-placement="bottom" href="tel:<?php if($contact3){ echo $contact3->phone;  }?>">
                <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
                  width="20" height="20"
                  viewBox="0 0 172 172"
                  style=" fill:#000000;"><g fill="none" fill-rule="nonzero" stroke="none" stroke-width="1" stroke-linecap="butt" stroke-linejoin="miter" stroke-miterlimit="10" stroke-dasharray="" stroke-dashoffset="0" font-family="none" font-weight="none" font-size="none" text-anchor="none" style="mix-blend-mode: normal"><path d="M0,172v-172h172v172z" fill="none"></path><g fill="#000000"><path d="M112.875,106.425l-18.20333,18.13167c-10.97933,-5.7835 -19.77283,-12.52017 -27.219,-20.00933c-7.48917,-7.44617 -14.22583,-16.23967 -20.00933,-27.219l18.13167,-18.20333l-4.57233,-37.625h-39.50267c0,0 0,2.35067 0,7.16667c0,32.5295 13.18667,63.597 35.58967,86.24367c22.64667,22.403 53.71417,35.58967 86.24367,35.58967c4.816,0 7.16667,0 7.16667,0v-39.50267z"></path></g></g>
                </svg>
              </a>
...
<blockquote class="card">
  <div class="section section-about-us"><!--start section-about-us-->
                ...
                <div class="row">
                  <div class="col-md-12">
                    <div class="team-player">
                      ...
                      <a><img src="<?php echo base_url('upload/dashboard/'.$key->file) ?>" style="width: 20%" alt="Conveyor img"><?php echo $key->text ?> &nbsp;</a>
                    <?php } ?>
                    </div>
                </div>
              </div>
      ...
      <br>
      <p class="text-center"><a href="<?php echo site_url('admin/home_page/action/product_category') ?>" class="btn btn-info" >Edit / Product Category</a></p>
    </div>
...
<blockquote class="card">
    <div class="section section-team text-center">
      ...
      <p class="text-center"><a href="<?php echo site_url('admin/Home_page/action/application_field') ?>" class="btn btn-info">Edit / Application Field</a></p>
    </div>
</blockquote>
...
<blockquote class="card">
    <div class="container"><!--Our Advantage-->
      ...
      <p class="text-center"><a href="<?php echo site_url('admin/home_page/action/our_advantages') ?>" class="btn btn-info" >Edit / Our Advantages</a></p>
...
<blockquote class="card">
    <div class="section section-team text-center">
      ...
      <p class="text-center"><a href="<?php echo site_url('admin/Home_page/action/our_partner') ?>" class="btn btn-info">Edit / Our Partner</a></p>
    </div>
</blockquote>


<blockquote class="card" style="height: auto;">
  ...
  <div class="container text-center text-md-left">
    ...
    <div class="row">
      ...
      <div class="col-md-6 mb-md-0 mb-3">
        ...
        <div class="row">
          <div class="col-md-4">
            <b style="font-size: 14px"> <?php echo $key->kota ?></b>
          </div>
          <div class="col-md-8">
      ...
      <?php foreach ($contact as $key ) { ?>
        <div class="row">
          <div class="col-md-4">
            <b style="font-size: 14px"><?php echo $key->contact; ?></b>
          </div>
          <div class="col-md-8">
            <address style="font-size: 14px"><?php echo $key->number; ?></address>
          </div>
        </div>
      <?php } ?>
      <!-- Grid column -->
    ...
    <!-- Grid column -->
      <div class="col-md-6 mt-md-0 mt-3" style="height: auto;">
            <h5 class="text-uppercase font-weight-bold">Maps</h5>
            <!-- Content -->
        <div>
         <?php foreach ($maps as $key ) { ?> <?php echo $key->maps ?>  <?php } ?>
        </div> 
      </div>
  </div>
  </div>
  <br>
  <p class="text-center"><a href="<?php echo site_url('admin/Home_page/action/address') ?>" class="btn btn-info">Edit / Contact & Maps</a></p>
</footer>
</blockquote>
