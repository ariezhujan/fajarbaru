<blockquote class="card">
    <div class="section section-team text-center">
      <div class="container">
      <h2 class="title">Konten About 3</h2>
          ...
          <!--Table head-->
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                  <a href="javascript:;" data-id="<?php echo $key->id ?>" data-icon="<?php echo  $key->icon ?>" data-text="<?php echo  $key->text ?>"  data-toggle="modal" data-target="#edit-data"><button  data-toggle="modal" data-target="#ubah-data" class="btn btn-sm btn-info"><i class="now-ui-icons ui-2_settings-90"></i></button>
                   </a>
                </td>
                <td>
                      ...
                      <div class="form-group">
                          <div class="col-md-12">
                            ...
                            <br>
                              ...
                              <input class="form-control" id="icon" name="field1" required="required">
                          </div>
                          <div class="col-md-12">
                            <br>
                            <br>
                              <input class="form-control" id="text" name="field2" required="required">
                          </div>
                          <br>
                          <br>
                          <br>
...
<script type="text/javascript">
 $(document).ready(function(){
  ...
  $('#add').click(function(){
    i++;
    $('#dynamic_field').append('<div class="row" style="margin-left:40px" id="row'+i+'"><input type="hidden" value="2" name="page" ><input type="hidden" value="3" name="sub" ><input type="hidden" value="'+i+'" name="field"><div class="col-md-10"><input class="input form-control" name="field1[]" type="text" placeholder="Text Icon" required/></div><div class="col-md-10"><input class="input form-control" name="field2[]" type="text" placeholder="Type something" required/></div><button type="button" name="remove" id="'+i+'" title="Hapus Input Data" class="btn_remove btn btn-danger" style="margin-top:5px;margin-left: 0px;"><i class="now-ui-icons ui-1_simple-delete"></i></button></div>');
  });
