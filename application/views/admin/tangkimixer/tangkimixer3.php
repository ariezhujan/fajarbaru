<blockquote class="card">
    <div class="section section-team text-center">
      <div class="container">
      <h2 class="title">Konten Tangki dan Mixer 3</h2>
          ...
          <!--Table head-->
            ...
            <tbody>
              ...
              <tr>
                ...
                <td><img style="width: 100%" src="<?php echo site_url('upload/tangkimixer/'. $key->file) ?>" ></td>
                <td>
                ...
                <td>
                  <a href="<?php echo site_url('admin/tangkimixer_page/tangkimixer3_remove') ?>?id=<?php echo $key->id ?>" title="Hapus" class="btn btn-sm btn-danger"><i class="now-ui-icons ui-1_simple-remove"></i></a>
                </td>
              </tr>
              <?php } ?>
            </tbody>
        ...
        <div class="col-sm-6 col-lg-10">
           <div class="panel panel-default">
            ...
            <div class="panel-body">
              ...
              <form action="<?php echo site_url('admin/tangkimixer_page/tangkimixer3') ?>" enctype="multipart/form-data" method="post" accept-charset="utf-8">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="col-sm-12 col-md-12 col-lg-12">
                <div class="row">
                <form class="form-horizontal" action="<?php echo base_url('admin/tangkimixer_page/tangkimixer3_edit')?>" method="post" enctype="multipart/form-data" role="form">
                      ...
                      <div class="form-group">
                          ...
                          <div class="col-md-12">
                            ...
                            <label>Images File</label>
                              <input id="file" type="file" class="form-control" name="field2" required="required">
                          </div>
                          <br>
                          <br>
                          <br>
...
<script type="text/javascript">
 $(document).ready(function(){
  ...
  $('#add').click(function(){
    i++;
    $('#dynamic_field').append('<div class="row" style="margin-left:40px" id="row'+i+'"><input type="hidden" value="4" name="page" ><input type="hidden" value="3" name="sub" ><input type="hidden" value="'+i+'" name="field"><div class="col-md-12" style="margin-top:50px; padding-bottom:50px;"><textarea style="height:200px" class="input form-control" name="field1'+i+'" type="text" placeholder="Type something" required/></textarea></div><div class="col-md-12" style="margin-top:50px; padding-bottom:50px;"><input class="input form-control" name="field2'+i+'" type="file" placeholder="Type something" required/></div><button type="button" name="remove" id="'+i+'" title="Hapus Input Data" class="btn_remove btn btn-danger" style="margin-top:5px;margin-left: 0px;"><i class="now-ui-icons ui-1_simple-delete"></i></button></div>');
  });
