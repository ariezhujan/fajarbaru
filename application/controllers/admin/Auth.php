...
class Auth extends CI_Controller
{
		...
		if ($this->form_validation->run() === TRUE)
		{
			...
			if ($this->ion_auth->login($this->input->post('identity'), $this->input->post('password'), $remember))
			{
				...
				$data = [
					...
					'time' => $this->input->post('tgl'),
				];

				//Jika cek Data Insert dan Update data
				/*$where= [
					'id_user' => $user = $this->ion_auth->get_user_id(),
				];
				if ($this->M_data->tampil_data()->result()) {
					$this->M_data->update_data($where,$data,'login_attempts');
				} else {
					$this->M_data->input_data($data,'login_attempts');
				}*/
	...
	*/
	...
	public function edit_user($id)
	{
		...
		$data['content'] = 'admin/auth/edit_user';
		$this->load->view('admin/master', $data);
